  ...
  return (
    <div className="font-sans bg-neutral-light text-secondary min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gray-800 py-1">
          <div className="bg-gradient-to-br from-blue-900 via-primary-dark to-primary-dark">
            <div className="container mx-auto px-4 py-12 md:py-20">
              <div className="text-center mb-8">
                ...
                <p className="text-white text-lg max-w-2xl mx-auto font-bold drop-shadow-md">
